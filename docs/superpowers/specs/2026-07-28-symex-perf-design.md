...
of the whole speedup — the encoding change plus the session / model-cache /
ladder levers, with interactive demos — open
`2026-07-28-symex-perf-explainer.html` in a browser.
