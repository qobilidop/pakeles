...
| `proto` | 16 | hex | Protocol Type | 2048=IPv4, 34525=IPv6, 25944=TEB |  |
...
|---|---|---|---|---|---|
| `is_encap` | 1 | 0 | dec | Encapsulated | set on tunnel re-entry (IPIP / IPv6-in-IP), mirroring bpf_flow_keys.is_encap |
