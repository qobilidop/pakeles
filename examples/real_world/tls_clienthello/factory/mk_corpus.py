...
lines are byte-identical twins of the example crate's
project_tests.
...
print("# examples/real_world/tls_clienthello/factory/capture.sh. Sections mirror")
print("# the design doc's matrix; several lines are twins of the example crate's")
