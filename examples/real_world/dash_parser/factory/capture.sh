...
# (unprivileged):
#   ./dev.sh examples/real_world/dash_parser/factory/capture.sh                # mint committed golden
#   ./dev.sh examples/real_world/dash_parser/factory/capture.sh witnesses.txt  # replay any corpus-shaped file to stdout
set -euo pipefail
cd "$(dirname "$0")"
