/* Generated by pakeles from `eth_ipvx_l4` (eBPF variant). Do not edit:
...
static __attribute__((always_inline)) int pk_eth_ipvx_l4_parse_core(const uint8_t *buf, uint64_t bit_len, pk_eth_ipvx_l4_result_t *out) {
  uint64_t off = 0;
...
uint64_t pk_entry(void *mem) {
  ...
  pk_eth_ipvx_l4_result_t out = {0};
  pk_eth_ipvx_l4_parse_core(m + 8, bit_len, &out);
