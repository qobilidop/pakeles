/* Generated by pakeles from `katran_flow`. Do not edit:
...
static int pk_katran_flow_parse_core(const uint8_t *buf, uint64_t bit_len, pk_katran_flow_result_t *out) {
  uint64_t off = 0;
...
int pk_katran_flow_parse(const uint8_t *buf, uint64_t bit_len, pk_katran_flow_result_t *out) {
  pk_katran_flow_result_t zero = {0};
  *out = zero;
  return pk_katran_flow_parse_core(buf, bit_len, out);
}

const char *pk_katran_flow_reason_str(uint16_t reason) {
  switch (reason) {
