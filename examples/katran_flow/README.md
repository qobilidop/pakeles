...
factory ([`oracle/katran/factory/`](../../oracle/katran/factory/)):
...
diff katran`) diffs our projection ([`src/oracle/katran.rs`](../../src/oracle/katran.rs))
against the committed golden. Re-minting is privileged (in-kernel
TEST_RUN):

```sh
./dev-priv.sh oracle/katran/factory/capture.sh
```
