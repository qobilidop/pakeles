-- Generated by pakeles from `gibb_edge` (ir 0.2.0).
...
local pf = {}
pf.f_hdr_ethernet = ProtoField.none("pakeles_gibb_edge.ethernet", "ethernet")
pf.f_ethernet_dst_addr = ProtoField.ether("pakeles_gibb_edge.ethernet.dst_addr", "Destination")
pf.f_ethernet_src_addr = ProtoField.ether("pakeles_gibb_edge.ethernet.src_addr", "Source")
pf.f_ethernet_ether_type = ProtoField.uint16("pakeles_gibb_edge.ethernet.ether_type", "EtherType", base.HEX, { [2048] = "IPv4", [34525] = "IPv6", [34887] = "MPLS (unicast)", [34888] = "MPLS (multicast)" })
pf.f_hdr_mpls = ProtoField.none("pakeles_gibb_edge.mpls", "mpls")
pf.f_mpls_label = ProtoField.uint24("pakeles_gibb_edge.mpls.label", "Label", base.DEC)
pf.f_mpls_tc = ProtoField.uint8("pakeles_gibb_edge.mpls.tc", "Traffic Class", base.HEX)
pf.f_mpls_bos = ProtoField.uint8("pakeles_gibb_edge.mpls.bos", "Bottom of Stack", base.HEX)
pf.f_mpls_ttl = ProtoField.uint8("pakeles_gibb_edge.mpls.ttl", "TTL", base.DEC)
pf.f_hdr_mpls_payload_nibble = ProtoField.none("pakeles_gibb_edge.mpls_payload_nibble", "mpls_payload_nibble")
pf.f_mpls_payload_nibble_v = ProtoField.uint8("pakeles_gibb_edge.mpls_payload_nibble.v", "First Nibble", base.DEC, { [0] = "Ethernet-over-MPLS", [4] = "IPv4", [6] = "IPv6" })
pf.f_hdr_ipv4 = ProtoField.none("pakeles_gibb_edge.ipv4", "ipv4")
pf.f_ipv4_version = ProtoField.uint8("pakeles_gibb_edge.ipv4.version", "Version", base.HEX)
pf.f_ipv4_ihl = ProtoField.uint8("pakeles_gibb_edge.ipv4.ihl", "IHL", base.DEC)
pf.f_ipv4_diffserv = ProtoField.uint8("pakeles_gibb_edge.ipv4.diffserv", "DiffServ", base.HEX)
pf.f_ipv4_total_len = ProtoField.uint16("pakeles_gibb_edge.ipv4.total_len", "Total Length", base.DEC)
pf.f_ipv4_identification = ProtoField.uint16("pakeles_gibb_edge.ipv4.identification", "Identification", base.HEX)
pf.f_ipv4_flags = ProtoField.uint8("pakeles_gibb_edge.ipv4.flags", "Flags", base.HEX)
pf.f_ipv4_frag_offset = ProtoField.uint16("pakeles_gibb_edge.ipv4.frag_offset", "Fragment Offset", base.DEC)
pf.f_ipv4_ttl = ProtoField.uint8("pakeles_gibb_edge.ipv4.ttl", "TTL", base.DEC)
pf.f_ipv4_protocol = ProtoField.uint8("pakeles_gibb_edge.ipv4.protocol", "Protocol", base.DEC)
pf.f_ipv4_hdr_checksum = ProtoField.uint16("pakeles_gibb_edge.ipv4.hdr_checksum", "Header Checksum", base.HEX)
pf.f_ipv4_src_addr = ProtoField.uint32("pakeles_gibb_edge.ipv4.src_addr", "Source", base.HEX)
pf.f_ipv4_dst_addr = ProtoField.uint32("pakeles_gibb_edge.ipv4.dst_addr", "Destination", base.HEX)
pf.f_ipv4_options = ProtoField.bytes("pakeles_gibb_edge.ipv4.options", "options")
pf.f_hdr_ipv4_rest = ProtoField.none("pakeles_gibb_edge.ipv4_rest", "ipv4_rest")
pf.f_ipv4_rest_ihl = ProtoField.uint8("pakeles_gibb_edge.ipv4_rest.ihl", "IHL", base.DEC)
pf.f_ipv4_rest_diffserv = ProtoField.uint8("pakeles_gibb_edge.ipv4_rest.diffserv", "DiffServ", base.HEX)
pf.f_ipv4_rest_total_len = ProtoField.uint16("pakeles_gibb_edge.ipv4_rest.total_len", "Total Length", base.DEC)
pf.f_ipv4_rest_identification = ProtoField.uint16("pakeles_gibb_edge.ipv4_rest.identification", "Identification", base.HEX)
pf.f_ipv4_rest_flags = ProtoField.uint8("pakeles_gibb_edge.ipv4_rest.flags", "Flags", base.HEX)
pf.f_ipv4_rest_frag_offset = ProtoField.uint16("pakeles_gibb_edge.ipv4_rest.frag_offset", "Fragment Offset", base.DEC)
pf.f_ipv4_rest_ttl = ProtoField.uint8("pakeles_gibb_edge.ipv4_rest.ttl", "TTL", base.DEC)
pf.f_ipv4_rest_protocol = ProtoField.uint8("pakeles_gibb_edge.ipv4_rest.protocol", "Protocol", base.DEC)
pf.f_ipv4_rest_hdr_checksum = ProtoField.uint16("pakeles_gibb_edge.ipv4_rest.hdr_checksum", "Header Checksum", base.HEX)
pf.f_ipv4_rest_src_addr = ProtoField.uint32("pakeles_gibb_edge.ipv4_rest.src_addr", "Source", base.HEX)
pf.f_ipv4_rest_dst_addr = ProtoField.uint32("pakeles_gibb_edge.ipv4_rest.dst_addr", "Destination", base.HEX)
pf.f_ipv4_rest_options = ProtoField.bytes("pakeles_gibb_edge.ipv4_rest.options", "options")
pf.f_hdr_ipv6 = ProtoField.none("pakeles_gibb_edge.ipv6", "ipv6")
pf.f_ipv6_version = ProtoField.uint8("pakeles_gibb_edge.ipv6.version", "Version", base.HEX)
pf.f_ipv6_traffic_class = ProtoField.uint8("pakeles_gibb_edge.ipv6.traffic_class", "Traffic Class", base.HEX)
pf.f_ipv6_flow_label = ProtoField.uint24("pakeles_gibb_edge.ipv6.flow_label", "Flow Label", base.HEX)
pf.f_ipv6_payload_len = ProtoField.uint16("pakeles_gibb_edge.ipv6.payload_len", "Payload Length", base.DEC)
pf.f_ipv6_next_hdr = ProtoField.uint8("pakeles_gibb_edge.ipv6.next_hdr", "Next Header", base.DEC)
pf.f_ipv6_hop_limit = ProtoField.uint8("pakeles_gibb_edge.ipv6.hop_limit", "Hop Limit", base.DEC)
pf.f_ipv6_src_addr = ProtoField.bytes("pakeles_gibb_edge.ipv6.src_addr", "src_addr")
pf.f_ipv6_dst_addr = ProtoField.bytes("pakeles_gibb_edge.ipv6.dst_addr", "dst_addr")
pf.f_hdr_ipv6_rest = ProtoField.none("pakeles_gibb_edge.ipv6_rest", "ipv6_rest")
pf.f_ipv6_rest_traffic_class = ProtoField.uint8("pakeles_gibb_edge.ipv6_rest.traffic_class", "Traffic Class", base.HEX)
pf.f_ipv6_rest_flow_label = ProtoField.uint24("pakeles_gibb_edge.ipv6_rest.flow_label", "Flow Label", base.HEX)
pf.f_ipv6_rest_payload_len = ProtoField.uint16("pakeles_gibb_edge.ipv6_rest.payload_len", "Payload Length", base.DEC)
pf.f_ipv6_rest_next_hdr = ProtoField.uint8("pakeles_gibb_edge.ipv6_rest.next_hdr", "Next Header", base.DEC)
pf.f_ipv6_rest_hop_limit = ProtoField.uint8("pakeles_gibb_edge.ipv6_rest.hop_limit", "Hop Limit", base.DEC)
pf.f_ipv6_rest_src_addr = ProtoField.bytes("pakeles_gibb_edge.ipv6_rest.src_addr", "src_addr")
pf.f_ipv6_rest_dst_addr = ProtoField.bytes("pakeles_gibb_edge.ipv6_rest.dst_addr", "dst_addr")
pf.f_hdr_eompls_rest = ProtoField.none("pakeles_gibb_edge.eompls_rest", "eompls_rest")
pf.f_eompls_rest_reserved = ProtoField.uint16("pakeles_gibb_edge.eompls_rest.reserved", "Reserved", base.HEX)
pf.f_eompls_rest_seq_no = ProtoField.uint16("pakeles_gibb_edge.eompls_rest.seq_no", "Sequence Number", base.DEC)
pf.f_hdr_ethernet2 = ProtoField.none("pakeles_gibb_edge.ethernet2", "ethernet2")
pf.f_ethernet2_dst_addr = ProtoField.ether("pakeles_gibb_edge.ethernet2.dst_addr", "Destination")
pf.f_ethernet2_src_addr = ProtoField.ether("pakeles_gibb_edge.ethernet2.src_addr", "Source")
pf.f_ethernet2_ether_type = ProtoField.uint16("pakeles_gibb_edge.ethernet2.ether_type", "EtherType", base.HEX, { [2048] = "IPv4", [34525] = "IPv6", [34887] = "MPLS (unicast)", [34888] = "MPLS (multicast)" })
pf.f_payload = ProtoField.bytes("pakeles_gibb_edge.payload", "Payload")
p.fields = { pf.f_hdr_ethernet, pf.f_ethernet_dst_addr, pf.f_ethernet_src_addr, pf.f_ethernet_ether_type, pf.f_hdr_mpls, pf.f_mpls_label, pf.f_mpls_tc, pf.f_mpls_bos, pf.f_mpls_ttl, pf.f_hdr_mpls_payload_nibble, pf.f_mpls_payload_nibble_v, pf.f_hdr_ipv4, pf.f_ipv4_version, pf.f_ipv4_ihl, pf.f_ipv4_diffserv, pf.f_ipv4_total_len, pf.f_ipv4_identification, pf.f_ipv4_flags, pf.f_ipv4_frag_offset, pf.f_ipv4_ttl, pf.f_ipv4_protocol, pf.f_ipv4_hdr_checksum, pf.f_ipv4_src_addr, pf.f_ipv4_dst_addr, pf.f_ipv4_options, pf.f_hdr_ipv4_rest, pf.f_ipv4_rest_ihl, pf.f_ipv4_rest_diffserv, pf.f_ipv4_rest_total_len, pf.f_ipv4_rest_identification, pf.f_ipv4_rest_flags, pf.f_ipv4_rest_frag_offset, pf.f_ipv4_rest_ttl, pf.f_ipv4_rest_protocol, pf.f_ipv4_rest_hdr_checksum, pf.f_ipv4_rest_src_addr, pf.f_ipv4_rest_dst_addr, pf.f_ipv4_rest_options, pf.f_hdr_ipv6, pf.f_ipv6_version, pf.f_ipv6_traffic_class, pf.f_ipv6_flow_label, pf.f_ipv6_payload_len, pf.f_ipv6_next_hdr, pf.f_ipv6_hop_limit, pf.f_ipv6_src_addr, pf.f_ipv6_dst_addr, pf.f_hdr_ipv6_rest, pf.f_ipv6_rest_traffic_class, pf.f_ipv6_rest_flow_label, pf.f_ipv6_rest_payload_len, pf.f_ipv6_rest_next_hdr, pf.f_ipv6_rest_hop_limit, pf.f_ipv6_rest_src_addr, pf.f_ipv6_rest_dst_addr, pf.f_hdr_eompls_rest, pf.f_eompls_rest_reserved, pf.f_eompls_rest_seq_no, pf.f_hdr_ethernet2, pf.f_ethernet2_dst_addr, pf.f_ethernet2_src_addr, pf.f_ethernet2_ether_type, pf.f_payload }
...
function states.parse_ipv4_rest(buf, pinfo, tree, off, depth)
  ...
  hdr_ipv4_rest:add(pf.f_ipv4_rest_protocol, buf(math.floor(off / 8), math.floor((off % 8 + 8 + 7) / 8)), buf():bitfield(off, 8))
  off = off + 8
  if off + 16 > avail then
...
function states.parse_ipv6_rest(buf, pinfo, tree, off, depth)
  ...
  hdr_ipv6_rest:add(pf.f_ipv6_rest_next_hdr, buf(math.floor(off / 8), math.floor((off % 8 + 8 + 7) / 8)), buf():bitfield(off, 8))
  off = off + 8
  if off + 8 > avail then
