...
#ifndef PK_GIBB_SERVICE_PROVIDER_H
#define PK_GIBB_SERVICE_PROVIDER_H

#include <stdint.h>
#include <stddef.h>

enum { PK_GIBB_SERVICE_PROVIDER_ACCEPT = 0, PK_GIBB_SERVICE_PROVIDER_REJECT = 1 };
...
#endif /* PK_GIBB_SERVICE_PROVIDER_H */
