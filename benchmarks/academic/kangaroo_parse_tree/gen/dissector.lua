...
pf.f_ethernet2_dst_addr = ProtoField.ether("pakeles_kangaroo_parse_tree.ethernet2.dst_addr", "Destination")
pf.f_ethernet2_src_addr = ProtoField.ether("pakeles_kangaroo_parse_tree.ethernet2.src_addr", "Source")
