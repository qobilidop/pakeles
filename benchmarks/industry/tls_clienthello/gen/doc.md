...
| Field | Bits | Format | Name | Labels | Notes |
|---|---|---|---|---|---|
| `typ` | 8 | hex | Handshake Type | 1=client\_hello |  |
...
| Field | Bits | Format | Name | Labels | Notes |
|---|---|---|---|---|---|
| `typ` | 16 | hex | Extension Type | 0=server\_name |  |
...
| Field | Bits | Format | Name | Labels | Notes |
|---|---|---|---|---|---|
| `ntype` | 8 | hex | Name Type | 0=host\_name |  |
...
| `cs_odd` | 1 | 0 | dec | Odd Cipher Length | cipher\_suites parity |
