...
compared by the example crate (`benchmarks/industry/katran_parser/src/lib.rs`) against goldens minted by katran
itself under BPF_PROG_TEST_RUN (`benchmarks/industry/katran_parser/factory/`).
