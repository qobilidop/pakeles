...
#   ./dev.sh benchmarks/industry/sai_parser/factory/capture.sh          # mint committed golden
#   ./dev.sh benchmarks/industry/sai_parser/factory/capture.sh smoke.txt  # print to stdout
set -euo pipefail
cd "$(dirname "$0")"
